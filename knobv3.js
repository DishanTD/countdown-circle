...
(function (e) {
    ...
    t.o = function () {
        ...
        this.run = function () {
            ...
            this.$c = e(document.createElement("canvas")).attr({ width: Math.ceil(this.o.width), height: Math.ceil(this.o.height) });
            this.$div = e('<div style="' + (this.o.inline ? "display:inline;" : "") + "width:" + Math.ceil(this.o.width) + "px;height:" + Math.ceil(this.o.height) + "px;" + '"></div>');
        ...
        this._carve = function () {
            if (this.relative) {
                ...
                this.w = Math.ceil(this.o.width);
                this.h = Math.ceil(this.o.height);
            }
            this.$div.css({ width: Math.ceil(this.w) + "px", height: Math.ceil(this.h) + "px" });
            this.$c.attr({ width: Math.ceil(this.w), height: Math.ceil(this.h) });
            if (this.scale !== 1) {
                this.$c[0].width = Math.ceil(this.$c[0].width * this.scale);
                this.$c[0].height = Math.ceil(this.$c[0].height * this.scale);
                this.$c.width(Math.ceil(this.w));
                this.$c.height(Math.ceil(this.h));
            }
            return this;
        };
        this._draw = function () {
